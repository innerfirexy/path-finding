...
;;(graphical-solve "demo.png" (cons 1010 1035) (cons 350 600))
...
(defparameter *show-lines-of-sight* t)
...
;(load "./salza/package.lisp")
;(require "SALZA2" "./salza")
;(load "./zpng/package.lisp")
;(require "zpng" "./zpng")
;(load "./zpb-ttf/package.lisp")
;(require "ZPB_TTF" "./zpb-ttf")


;( load "./cl-vectors/paths-package.lisp")
;( load "./cl-vectors/vectors.lisp")
;(require "cl-vectors" "./cl-vectors")
;( load "./vecto/package.lisp")
;(require "vecto" "./vecto")
;(load "./skippy/package.lisp")
;(require "SKIPPY" "./skippy")

;(load "find-path-Moojan.lisp")


;(load "./cl-ppcre/packages.lisp")
;(require "cl-ppcre" "./cl-ppcre")
...
;(require "cl-ppcre-unicode" "./cl-ppcre/cl-ppcre-unicode")
;(require "CL_UNICODE" "./cl-unicode")

;( load "./cl-ppcre/packages.lisp")
;(require "ppcre" "./cl-ppcre")
